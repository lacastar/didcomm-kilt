<template>
    <v-app>
        ...
        <v-navigation-drawer v-model="drawer" theme="dark" absolute permanent :rail="rail" @click="rail = false">
            <v-list-item  :title="kiltStore.activeDid.name" nav> <!-- prepend-avatar="https://randomuser.me/api/portraits/men/85.jpg" -->
        ...
        :variant="selectedPeer==room?'tonal':'plain'">
            ...
            <v-list>
                ...
                <v-list-item link  @click="invite()">
                    ...
                    <template v-slot:prepend>
                        <v-btn variant="text" icon="mdi-account-plus-outline"
                            @click="invite()"></v-btn>
                    </template>
            ...
            <v-container class="py-8 px-6" fluid>
                <v-row v-if="selectedPeer">
                    <v-col  cols="12">
                        ...
                        @click:append="sendMessage" @keydown.enter="sendMessage" append-icon="mdi-send"></v-text-field>
                    </v-col>
                </v-row>
